...
export default function ModuleLayout({ accentColor = 'var(--color-primary)', domaine, description, children }) {
  ...
  const isEmbedded = location.pathname.startsWith('/visualisations/')

  return (
    <div className={`module-layout${isEmbedded ? ' module-layout--embedded' : ''}`} style={{ '--module-accent': accentColor }}>
